...
### 4. ms-ticketing (Puerto: 8094 | BD: db_ticketing)
...
### 5. ms-payment-mock (Puerto: 8095 | BD: db_payment)
...
### 6. ms-competition-reg (Puerto: 8091 | BD: db_competition)
...
### 7. ms-vehicle-registry (Puerto: 8098 | BD: db_vehicle)
...
### 8. ms-live-scoreboard (Puerto: 8097 | BD: db_scoreboard)
...
### 9. ms-notification-log (Puerto: 8093 | BD: db_notification)
...
### 10. ms-analytics-report (Puerto: 8099 | BD: db_analytics)
